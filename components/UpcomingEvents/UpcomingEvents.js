            ...
            <section className="upcoming__events">
                ...
                <div className='grid grid-cols-12 place-items-center w-10/12 mx-auto mt-[40px]'>
                    ...
                    <div className='w-[500px] col-span-6'>
                        ...
                        <p className='text-[24px] font-[500] text-[#565656] font-robotoSerif text-justify'>Take the challenge of our fun,  exciting and knowledge-boosting activity for kids.we are indroducing science quiz a platform that make the kids learn while enjoying</p>
