        ...
        <>
            <section className="winners__and__gallery">
                <div className='text-center pt-[10px]'>
                    <h2 className='text-[46px] leading-[60px] text-[#FFECFF] font-robotoSerif font-[700]'>Winners for Last Week</h2>
                </div>
                <div className='flex justify-around mt-[20px]'>
                    <div className='ayush_kumar relative w-[250px]'>
                        ...
                        <div className='text-center'>
                            <p className='text-[14px] font-robotoSerif font-[600] text-[#FFEBFF]'>Ayush Kumar</p>
                            <p className='text-[14px] font-robotoSerif font-[600] text-[#FFEBFF]'>First Prize, Magic Science Contest</p>
                            <p className='text-[14px] font-robotoSerif font-[600] text-[#FFEBFF]'>Class 7th, Vikash Public School</p>
                        </div>
                    </div>
                    <div className='ria-dash relative w-[250px]'>
                        ...
                        <div className='text-center'>
                            <p className='text-[14px] font-robotoSerif font-[600] text-[#FFEBFF]'>Ria Dash</p>
                            <p className='text-[14px] font-robotoSerif font-[600] text-[#FFEBFF]'>Second Prize, Magic Science Contest</p>
                            <p className='text-[14px] font-robotoSerif font-[600] text-[#FFEBFF]'>Class 9th, Rotary Public School</p>
                        </div>
                    </div>
                    <div className='ayush_kumar relative w-[250px]'>
                        <div>
                        ...
                        <div className='text-center'>
                            <p className='text-[14px] font-robotoSerif font-[600] text-[#FFEBFF]'>Silpa Mishra</p>
                            <p className='text-[14px] font-robotoSerif font-[600] text-[#FFEBFF]'>Third Prize, Magic Science Contest</p>
                            <p className='text-[14px] font-robotoSerif font-[600] text-[#FFEBFF]'>Class 6th, Rainbow Public School</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='text-center py-[30px]'>
                    <h2 className='text-[46px] leading-[60px] text-[#FFECFF] font-robotoSerif font-[700]'>Gallery</h2>
                </div>
                <Swiper className='w-10/12 mx-auto'
                    slidesPerView={4}
                    autoplay={{ delay: 2000 }}
                    speed={1300}
                    spaceBetween={20}
